...
import 'package:delicious_commerce/models/products_model.dart';
...
import 'package:delicious_commerce/widgets/app_column.dart';
import 'package:delicious_commerce/widgets/big_text.dart';
import 'package:delicious_commerce/widgets/icon_and_text_widget.dart';
                    ...
                    child: PageView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return _buildPageItem(
                            index, popularProducts.popularProducList[index]);
                      },
                    ),
                  )
                : Container(
          ...
          builder: (recommendedProduct) {
            return recommendedProduct.isLoaded
                ? ListView.builder(
                    ...
                    shrinkWrap: true,
                    itemCount: recommendedProduct.recommendedProducList.length,
                    itemBuilder: (context, index) {
